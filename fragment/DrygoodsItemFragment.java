...
public class DrygoodsItemFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        view = inflater.inflate(R.layout.fragment_drygoods_item, container, false);
        init();
        listener();
        return view;
    }
    ...
    public void init() {
        ...
        produceName = (TextView)view.findViewById(R.id.drygoods_tev);
    }
    ...
    public void listener() {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ProduceMSG produceMSG = new ProduceMSG(id,name,s,b,a,R.drawable.drygoods);
